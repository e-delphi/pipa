...
type
  ...
  private
    ...
    procedure ClientValidateServerCertificate(const Sender: TObject; const ARequest: TURLRequest;
...
begin
  ...
  Client.OnValidateServerCertificate := ClientValidateServerCertificate;
end;

procedure TRESTAPI.ClientValidateServerCertificate(const Sender: TObject; const ARequest: TURLRequest; const Certificate: TCertificate; var Accepted: Boolean);
begin
  Accepted := True;
end;
